package andlima.example.challengedelapan.view.main

import andlima.example.challengedelapan.func.alertDialog
import andlima.example.challengedelapan.func.toast
import andlima.example.challengedelapan.local.datastore.UserManager
import andlima.example.challengedelapan.model.film.GetMockFilmResponse
import andlima.example.challengedelapan.repository.DummyRepository
import andlima.example.challengedelapan.ui.component.*
import andlima.example.challengedelapan.ui.theme.*
import andlima.example.challengedelapan.view.start.LoginActivity
import andlima.example.challengedelapan.viewmodel.HomeViewModel
